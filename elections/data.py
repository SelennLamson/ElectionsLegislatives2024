...
# scénario du second tour réel
SREAL_ED = PartyVoteTransfer(ED, base_abstention_rate=0.5)
SREAL_ED.add_case(VoteTransferCase({ED: 1.0}))
SREAL_ED.add_case(VoteTransferCase({CEN: 0.20, NFP: 0.15}))
SREAL_ED.add_case(VoteTransferCase({LR: 0.20, NFP: 0.15}))
SREAL_ED.add_case(VoteTransferCase({LR: 0.3, CEN: 0.0}))
SREAL_LR = PartyVoteTransfer(LR, base_abstention_rate=0.5)
SREAL_LR.add_case(VoteTransferCase({LR: 1.0}))
SREAL_LR.add_case(VoteTransferCase({CEN: 0.4, NFP: 0.05}))
SREAL_LR.add_case(VoteTransferCase({ED: 0.36, NFP: 0.28}))
SREAL_LR.add_case(VoteTransferCase({ED: 0.26, CEN: 0.53}))
SREAL_CEN = PartyVoteTransfer(CEN, base_abstention_rate=0.5)
SREAL_CEN.add_case(VoteTransferCase({CEN: 1.0}))
SREAL_CEN.add_case(VoteTransferCase({ED: 0.19, NFP: 0.43}))
SREAL_CEN.add_case(VoteTransferCase({LR: 0.4, NFP: 0.3}))
SREAL_CEN.add_case(VoteTransferCase({ED: 0.04, LR: 0.79}))
SREAL_NFP = PartyVoteTransfer(NFP, base_abstention_rate=0.5)
SREAL_NFP.add_case(VoteTransferCase({NFP: 1.0}))
SREAL_NFP.add_case(VoteTransferCase({ED: 0.03, CEN: 0.72}))
SREAL_NFP.add_case(VoteTransferCase({LR: 0.0, CEN: 0.3}))
SREAL_NFP.add_case(VoteTransferCase({ED: 0.02, LR: 0.70}))
SREAL = VoteTransferModel([SREAL_ED, SREAL_LR, SREAL_CEN, SREAL_NFP])


# scénario du second tour réel, mais si le NFP fait barrage comme le CEN
SSURREAL_ED = PartyVoteTransfer(ED, base_abstention_rate=0.5)
SSURREAL_ED.add_case(VoteTransferCase({ED: 1.0}))
SSURREAL_ED.add_case(VoteTransferCase({CEN: 0.20, NFP: 0.15}))
SSURREAL_ED.add_case(VoteTransferCase({LR: 0.20, NFP: 0.15}))
SSURREAL_ED.add_case(VoteTransferCase({LR: 0.3, CEN: 0.0}))
SSURREAL_LR = PartyVoteTransfer(LR, base_abstention_rate=0.5)
SSURREAL_LR.add_case(VoteTransferCase({LR: 1.0}))
SSURREAL_LR.add_case(VoteTransferCase({CEN: 0.4, NFP: 0.05}))
SSURREAL_LR.add_case(VoteTransferCase({ED: 0.36, NFP: 0.28}))
SSURREAL_LR.add_case(VoteTransferCase({ED: 0.26, CEN: 0.53}))
SSURREAL_CEN = PartyVoteTransfer(CEN, base_abstention_rate=0.5)
SSURREAL_CEN.add_case(VoteTransferCase({CEN: 1.0}))
SSURREAL_CEN.add_case(VoteTransferCase({ED: 0.19, NFP: 0.43}))
SSURREAL_CEN.add_case(VoteTransferCase({LR: 0.4, NFP: 0.3}))
SSURREAL_CEN.add_case(VoteTransferCase({ED: 0.04, LR: 0.79}))
SSURREAL_NFP = PartyVoteTransfer(NFP, base_abstention_rate=0.5)
SSURREAL_NFP.add_case(VoteTransferCase({NFP: 1.0}))
SSURREAL_NFP.add_case(VoteTransferCase({ED: 0.19, CEN: 0.43}))
SSURREAL_NFP.add_case(VoteTransferCase({LR: 0.0, CEN: 0.3}))
SSURREAL_NFP.add_case(VoteTransferCase({ED: 0.36, LR: 0.28}))
SSURREAL = VoteTransferModel(
    [SSURREAL_ED, SSURREAL_LR, SSURREAL_CEN, SSURREAL_NFP])
